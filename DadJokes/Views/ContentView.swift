...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            //id: \.self    tells the list structure to identify each joke using the text of the joke                  itself
        ...
        .task {
            ...
            // We "call" the load new joke button to thell the computer to get a new joke
            //by typing await we are acknowledging that we know this function may be run at the same time aas other tasks in this app
            await loadNewJoke()
    ...
    //We must mark the function as "async" so that it ca be run asynchronously which means it may be run at the same time as other tasks.
